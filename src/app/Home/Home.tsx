...
const Home: React.FunctionComponent = () => (
  <>
    ...
    <PageSection variant="secondary">
      <Flex direction={{ default: 'column' }} alignItems={{ default: 'alignItemsCenter' }} justifyContent={{ default: 'justifyContentCenter' }} style={{ minHeight: '350px' }}>
        <Flex direction={{ default: 'column' }} alignItems={{ default: 'alignItemsCenter' }} style={{ width: '100%' }}>
          <Title headingLevel="h2" size="lg" style={{ textAlign: 'center', marginBottom: '1rem' }}>
            Templates & Proposals Overview
          </Title>
          <div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
            <svg width="800" height="260" viewBox="0 0 800 260" style={{ maxWidth: '100%', height: 'auto', marginBottom: '1rem', display: 'block' }}>
              {/* Templates box - wider */}
